...
public abstract class GenericTypeResolver {
	...
	public static Class<?> resolveParameterType(MethodParameter methodParam, Class<?> clazz) {
		...
		if (result==java.lang.Object.class){
			//in dynamic system ,Class is cast to Object
			//动太环境下，这个Class 指赂一个Object
			Dynamic beanAnn=methodParam.getParameterAnnotation(Dynamic.class);
			if (beanAnn!=null){
				String  classPath =beanAnn.value();
				try {
					result =clazz.getClassLoader().loadClass(classPath);
				}
